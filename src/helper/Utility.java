...
public class Utility {
    ...
    public static List<String> listFilesWithoutExtensionsFromPath(String path) {
    ...
    public static void addWordInCategory(int id,String newWord,String newHint,String categoryName)throws IOException{
